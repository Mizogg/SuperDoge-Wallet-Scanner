...
while True:
    ...
    print ("\n " + colour_cyan + "Random DOGE Scan" + colour_red + "---Good--Luck--Happy--Hunting--Mizogg.co.uk&Chad---" + colour_cyan + "With Balance/Received Checker" + colour_reset) # Running Display Output
